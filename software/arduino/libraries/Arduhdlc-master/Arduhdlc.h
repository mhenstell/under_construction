...
class Arduhdlc
{
  public:
    ...
    void send(const char *framebuffer, uint8_t frame_length);
    uint8_t makeBuffer(const uint8_t *framebuffer, uint8_t *output, uint8_t frame_length);
    void receiveArray(uint8_t *framebuffer, uint8_t frame_length);
